  ...
  <div class="form-container">
    <div class="form-box">
      ...
      <div class="input-group">
        ...
        <small class="status-msg" :class="{ 'error-text': nameAvailable === false, 'success-text': nameAvailable === true }">
          {{ nameMsg }}
        </small>
      </div>
...
input { width: 100%; padding: 12px 15px; padding-right: 40px; border: 1px solid var(--input-border); border-radius: 8px; font-size: 1rem; box-sizing: border-box; background-color: var(--input-bg); color: var(--text-color); transition: all 0.3s; }
