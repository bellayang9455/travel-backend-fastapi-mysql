...
.img-rating-badge { position: absolute; top: 10px; right: 10px; background: rgba(255, 215, 0, 0.95); color: #856404; font-weight: 800; font-size: 11px; padding: 3px 8px; border-radius: 20px; }
...
.btn-action { padding: 6px 14px; border-radius: 6px; border: none; cursor: pointer; font-size: 0.85rem; font-weight: bold; transition: all 0.2s ease; letter-spacing: 1px; }
...
.detail-img-overlay { position: absolute; bottom: 0; left: 0; right: 0; padding: 20px; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); display: flex; align-items: flex-end; }
...
.detail-location { color: var(--text-secondary); font-size: 1.1rem; margin-bottom: 25px; }
...
.detail-actions .btn-action { flex: 1; padding: 12px; font-size: 1rem; }
